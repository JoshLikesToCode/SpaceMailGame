...
import SpaceMail.game.TRE;
import SpaceMail.menus.EndGamePanel;
import SpaceMail.menus.StartMenuPanel;
...
public class Launcher {
    ...
    private static final ClassLoader launching = Launcher.class.getClassLoader();
    private static final InputStream soundName = launching.getResourceAsStream("Music.mid");
